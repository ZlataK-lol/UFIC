...
const WEEKS = [
  {
    ...
    color: '#4a9ab5',
    time: 'About 8 hours: 4 on the kickoff presentation and 4 on environment setup.',
    contribution: 'Built the project overview, Persona 1, and one user story for the team\'s Project Proposal Pitch, delivered as a class lecture and presentation at EDU Africa\'s office. Also set up the existing project environment on my own machine, and helped write the team status report.',
    reflection: 'Learned how to step into a project that was already underway rather than starting from scratch. Reading someone else\'s decisions instead of making my own from a blank page is its own skill, and week one was mostly building that muscle. Aika Swai\'s "South Africa in Context" workshop and our visit to the Slave Lodge gave me Cape Town\'s history, including Apartheid and the history of slavery before it, early enough that it reframed how I saw the city from day one and pushed me to learn from experience and listening rather than assumption for the rest of the program.',
    lesson: 'Learn from the people and history around you. Don\'t let secondhand impressions stand in for actually finding out.',
    culture: [
      { activity: 'Aika Swai\'s "South Africa in Context" workshop and the Slave Lodge', note: 'The first real grounding in Cape Town\'s history, including Apartheid and the slave trade that came before it, before I\'d even started meaningful project work. It shaped how I approached everything after.' },
  ...
  },
  {
    ...
    contribution: 'Built the AI chat frontend, including new/save/delete chat controls and the sidebar, and connected the assistant\'s API key so it could read from Safe Cities\' Google Drive.',
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-5 relative z-10">
            <div className="flex flex-col gap-1.5">
              ...
              <StaticField
                rows={5}
                value="I arrived already having interviewed the client remotely, but the six weeks on the ground were where the real work, and the real growth, actually happened. I went from setting up someone else's project environment in week one, to redesigning the AI assistant's cloud infrastructure around constraints nobody had planned for in week four, to presenting confidently to the client on July 12th in a way that would have felt completely out of reach back in week one. Looking at it week by week rather than all at once, the growth doesn't look like a single turning point: it looks like six small, deliberate corrections that added up."
              />
            </div>
            <div className="flex flex-col gap-1.5">
