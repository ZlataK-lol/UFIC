...
export default defineConfig(({ mode }) => {
  ...
  return {
    // For GitHub Pages project sites (username.github.io/repo-name), the base
    // path must match the repo name. The included GitHub Actions workflow sets
    // GH_PAGES_BASE automatically — you shouldn't need to touch this by hand.
